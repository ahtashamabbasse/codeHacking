...
{{--        <img src="{{$user->photo->photo}}" class="pull-right img-responsive img-thumbnail"  height="200px"  alt="">--}}
    ...
    <div class="col-sm-9">
        {!! Form::model(1,["method"=>"patch",'route'=>["admin.user.update",1],"class"=>"form-horizontal","files"=>"true"]) !!}
        ...
        <div class="form-group {{$errors->has('status')?'has-error':''}}">
            ...
            <div class="col-sm-9">
                {!! Form::select('is_active',[""=>"Select Status","0"=>"Not Active","1"=>"Active"],null,['class'=>"col-xs-10 col-sm-5","required"=>"required"]) !!}
        ...
        {!! Form::close() !!}
        {!! Form::open(["method"=>"DELETE","route"=>["admin.user.destroy",null]]) !!}
